...
<head>
    <meta charset="UTF-8">
    <!-- 1. INDISPENSABLE: Sin esto, el archivo mobile.css no funcionará en esta página -->
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    
    <!-- Cambiá el título según la página actual -->
    <title>Materiales HdA</title> 
    
    <!-- 2. TU ARCHIVO CENTRAL: Carga el escritorio y el celular al final automáticamente -->
    <link rel="stylesheet" href="../../css/main.css">
</head>
<body>

    <!-- 3. REUTILIZÁ EL HEADER: Copiá exactamente el mismo bloque de tu index.html -->
    <header> 
        <nav class="menu">
            <ul>
    ...
    <!-- 4. CONTENIDO ÚNICO: Lo único que cambia en cada página nueva -->
    <main>
        <section class="hero" id="inicio">
            <img class="fondo_hero" src="../images/principal/fondo2.png" alt="Hojas del Alma" aria-hidden="true">
            <div class="contenido_hero">
                <h1>Hojas del Alma</h1>
            ...
            <h2 id="titulo-moldes">Moldes</h2>
                    ...
                    <div class="tarjeta-inner">
                        <div class="tarjeta-front">
                            <div class="img-contenido">
                                <img src="../images/categorias/moldes/01.png" alt=" Chef / Gyuto occidental 20cm">
                            </div>
                            <div class="nombre-prod">
                                <h3> Gyuto occidental</h3>
                            </div>
                        </div>
                ...
                <article class="tarjeta-producto">
                    <div class="tarjeta-inner">
                        <div class="tarjeta-front">
                            <div class="img-contenido">
                                <img src="../images/categorias/moldes/02.png" alt=" Santoku Alveolado">
                            </div>
                            <div class="nombre-prod">
                                <h3> Santoku Alveolado</h3>
                            </div>
                        </div>
                        <div class="tarjeta-back">
                            <div class="contenido-back">
                ...
                <article class="tarjeta-producto">
                    <div class="tarjeta-inner">
                        <div class="tarjeta-front">
                            <div class="img-contenido">
                                <img src="../images/categorias/moldes/03.png" alt=" Mondador">
                            </div>
                            <div class="nombre-prod">
                                <h3> Mondador</h3>
                            </div>
                ...
                <article class="tarjeta-producto">
                    <div class="tarjeta-inner">
                        <div class="tarjeta-front">
                            <div class="img-contenido">
                                <img src="../images/categorias/moldes/04.png" alt=" Chef / Deshuesador Curvo">
                            </div>
                            <div class="nombre-prod">
                                <h3> Deshuesador Curvo</h3>
                            </div>
                        </div>
                        <div class="tarjeta-back">
                            <div class="contenido-back">
                ...
                <article class="tarjeta-producto">
                    <div class="tarjeta-inner">
                        <div class="tarjeta-front">
                            <div class="img-contenido">
                                <img src="../images/categorias/moldes/05.png" alt="Cuchillo de Pan">
                            </div>
                            <div class="nombre-prod">
                                <h3> Cuchillo de Pan</h3>
                            </div>
                        </div>
                        <div class="tarjeta-back">
                            <div class="contenido-back">
                ...
                <article class="tarjeta-producto">
                    <div class="tarjeta-inner">
                        <div class="tarjeta-front">
                            <div class="img-contenido">
                                <img src="../images/categorias/moldes/06.png" alt=" Cuchillo de Caza Bushcraft">
                            </div>
                            <div class="nombre-prod">
                                <h3> Cuchillo de Caza Bushcraft</h3>
                            </div>
                        </div>
                        <div class="tarjeta-back">
                            <div class="contenido-back">
                ...
                <article class="tarjeta-producto">
                    <div class="tarjeta-inner">
                        <div class="tarjeta-front">
                            <div class="img-contenido">
                                <img src="../images/categorias/moldes/07.png" alt=" Cuchillo Táctico de Supervivencia">
                            </div>
                            <div class="nombre-prod">
                                <h3> Cuchillo Táctico de Supervivencia</h3>
                            </div>
                        </div>
                        <div class="tarjeta-back">
                            <div class="contenido-back">
                ...
                <article class="tarjeta-producto">
                    <div class="tarjeta-inner">
                        <div class="tarjeta-front">
                            <div class="img-contenido">
                                <img src="../images/categorias/moldes/08.png" alt=" Bowie de Caza">
                            </div>
                            <div class="nombre-prod">
                                <h3> Bowie de Caza</h3>
                            </div>
                ...
                <article class="tarjeta-producto">
                    <div class="tarjeta-inner">
                        <div class="tarjeta-front">
                            <div class="img-contenido">
                                <img src="../images/categorias/moldes/09.png" alt=" Cuchillo de cuello">
                            </div>
                            <div class="nombre-prod">
                                <h3> Cuchillo de cuello</h3>
                            </div>
                        </div>
                        <div class="tarjeta-back">
                            <div class="contenido-back">
                ...
                <article class="tarjeta-producto">
                    <div class="tarjeta-inner">
                        <div class="tarjeta-front">
                            <div class="img-contenido">
                                <img src="../images/categorias/moldes/010.png" alt=" Cuchillo de monte">
                            </div>
                            <div class="nombre-prod">
                                <h3> Cuchillo de monte</h3>
                            </div>
                        </div>
                        <div class="tarjeta-back">
                            <div class="contenido-back">
            ...
            <div class="grid_galerias">
                <article class="tarjeta-producto">
                    <div class="tarjeta-inner">
                        <div class="tarjeta-front">
                            <div class="img-contenido">
                                <img src="../images/categorias/personalizados/01.png" alt=" De autor 1">
                            </div>
                            <div class="nombre-prod">
                                <h3> De autor 1</h3>
                            </div>
                ...
                <article class="tarjeta-producto">
                    <div class="tarjeta-inner">
                        <div class="tarjeta-front">
                            <div class="img-contenido">
                                <img src="../images/categorias/personalizados/02.png" alt=" De autor 2">
                            </div>
                            <div class="nombre-prod">
                                <h3> De autor 2</h3>
                            </div>
                ...
                <article class="tarjeta-producto">
                    <div class="tarjeta-inner">
                        <div class="tarjeta-front">
                            <div class="img-contenido">
                                <img src="../images/categorias/personalizados/03.png" alt=" De autor 3">
                            </div>
                            <div class="nombre-prod">
                                <h3> De autor 3</h3>
                            </div>
                ...
                <article class="tarjeta-producto">
                    <div class="tarjeta-inner">
                        <div class="tarjeta-front">
                            <div class="img-contenido">
                                <img src="../images/categorias/personalizados/04.png" alt=" De autor 4">
                            </div>
                            <div class="nombre-prod">
                                <h3> De autor 4</h3>
                            </div>
                ...
                <article class="tarjeta-producto">
                    <div class="tarjeta-inner">
                        <div class="tarjeta-front">
                            <div class="img-contenido">
                                <img src="../images/categorias/personalizados/05.png" alt=" De autor 5">
                            </div>
                            <div class="nombre-prod">
                                <h3> De autor 5</h3>
                            </div>
                ...
                <article class="tarjeta-producto">
                    <div class="tarjeta-inner">
                        <div class="tarjeta-front">
                            <div class="img-contenido">
                                <img src="../images/categorias/personalizados/06.png" alt=" De autor 6">
                            </div>
                            <div class="nombre-prod">
                                <h3> De autor 6</h3>
                            </div>
                ...
                <article class="tarjeta-producto">
                    <div class="tarjeta-inner">
                        <div class="tarjeta-front">
                            <div class="img-contenido">
                                <img src="../images/categorias/personalizados/07.png" alt=" De autor 7">
                            </div>
                            <div class="nombre-prod">
                                <h3> De autor 7</h3>
                            </div>
                ...
                <article class="tarjeta-producto">
                    <div class="tarjeta-inner">
                        <div class="tarjeta-front">
                            <div class="img-contenido">
                                <img src="../images/categorias/personalizados/08.png" alt=" De autor 8">
                            </div>
                            <div class="nombre-prod">
                                <h3> De autor 8</h3>
                            </div>
                ...
                <article class="tarjeta-producto">
                    <div class="tarjeta-inner">
                        <div class="tarjeta-front">
                            <div class="img-contenido">
                                <img src="../images/categorias/personalizados/09.png" alt=" De autor 9">
                            </div>
                            <div class="nombre-prod">
                                <h3> De autor 9</h3>
                            </div>
                ...
                <article class="tarjeta-producto">
                    <div class="tarjeta-inner">
                        <div class="tarjeta-front">
                            <div class="img-contenido">
                                <img src="../images/categorias/personalizados/010.png" alt=" De autor 10">
                            </div>
                            <div class="nombre-prod">
                                <h3> De autor 10</h3>
                            </div>
            ...
            <div class="grid_galerias">
                <article class="tarjeta-producto">
                    <div class="tarjeta-inner">
                        <div class="tarjeta-front">
                            <div class="img-contenido">
                                <img src="../images/categorias/restaurados/01.png" alt=" Chef">
                            </div>
                            <div class="nombre-prod">
                                <h3> Chef</h3>
                            </div>
                ...
                <article class="tarjeta-producto">
                    <div class="tarjeta-inner">
                        <div class="tarjeta-front">
                            <div class="img-contenido">
                                <img src="../images/categorias/restaurados/02.png" alt=" Cuchillo de carnicero">
                            </div>
                            <div class="nombre-prod">
                                <h3> Cuchillo de carnicero</h3>
                            </div>
                        </div>
                        <div class="tarjeta-back">
                            <div class="contenido-back">
                ...
                <article class="tarjeta-producto">
                    <div class="tarjeta-inner">
                        <div class="tarjeta-front">
                            <div class="img-contenido">
                                <img src="../images/categorias/restaurados/03.png" alt=" Chef Sebatier">
                            </div>
                            <div class="nombre-prod">
                                <h3> Chef Sebatier</h3>
                            </div>
                ...
                <article class="tarjeta-producto">
                    <div class="tarjeta-inner">
                        <div class="tarjeta-front">
                            <div class="img-contenido">
                                <img src="../images/categorias/restaurados/04.png" alt=" Bowie">
                            </div>
                            <div class="nombre-prod">
                                <h3> Bowie</h3>
                            </div>
                ...
                <article class="tarjeta-producto">
                    <div class="tarjeta-inner">
                        <div class="tarjeta-front">
                            <div class="img-contenido">
                                <img src="../images/categorias/restaurados/05.png" alt="Facon">
                            </div>
                            <div class="nombre-prod">
                                <h3> Facon</h3>
                            </div>
                ...
                <article class="tarjeta-producto">
                    <div class="tarjeta-inner">
                        <div class="tarjeta-front">
                            <div class="img-contenido">
                                <img src="../images/categorias/restaurados/06.png" alt=" Cuchillo Verijero">
                            </div>
                            <div class="nombre-prod">
                                <h3> Cuchillo Verijero</h3>
                            </div>
                        </div>
                        <div class="tarjeta-back">
                            <div class="contenido-back">
                ...
                <article class="tarjeta-producto">
                    <div class="tarjeta-inner">
                        <div class="tarjeta-front">
                            <div class="img-contenido">
                                <img src="../images/categorias/restaurados/07.png" alt=" Deshuesador">
                            </div>
                            <div class="nombre-prod">
                                <h3> Deshuesador</h3>
                            </div>
                ...
                <article class="tarjeta-producto">
                    <div class="tarjeta-inner">
                        <div class="tarjeta-front">
                            <div class="img-contenido">
                                <img src="../images/categorias/restaurados/08.png" alt=" De Caza">
                            </div>
                            <div class="nombre-prod">
                                <h3> De Caza</h3>
                            </div>
                ...
                <article class="tarjeta-producto">
                    <div class="tarjeta-inner">
                        <div class="tarjeta-front">
                            <div class="img-contenido">
                                <img src="../images/categorias/restaurados/09.png" alt=" Filetero">
                            </div>
                            <div class="nombre-prod">
                                <h3> Filetero</h3>
                            </div>
                ...
                <article class="tarjeta-producto">
                    <div class="tarjeta-inner">
                        <div class="tarjeta-front">
                            <div class="img-contenido">
                                <img src="../images/categorias/restaurados/010.png" alt="  De Campo">
                            </div>
                            <div class="nombre-prod">
                                <h3>  De Campo</h3>
                            </div>
    ...
    <!-- 5. REUTILIZÁ EL FOOTER: Copiá exactamente el mismo bloque de tu index.html -->
    <footer class="footer" id="contacto">
            <div class="foo_contenedor">
                <div class="foo_contacto">
                    <h2>Contacto</h2>
                    <p> Para contacto  usar cualquiera de las redes sociales.</p>
                </div>
                <div class="bann_foo">
                    <img  src="../images/principal/bann_foo.png" alt="Banner_footer">
                </div>
            ...
            <div class="foo_derechos">
                <p>© 2026 Hojas del Alma.</p>
            </div>
